...
| [`ec20-internet-plus-vowifi.toml`](ec20-internet-plus-vowifi.toml) | One EC20 card serving BOTH internet and VoWiFi calls. Bridge-side config is plain VoWiFi; internet comes from the opt-in cellular-internet sidecar, which the bridge waits on. See [`docs/ec20-internet-plus-vowifi.md`](../docs/ec20-internet-plus-vowifi.md) and `specs/032-cellular-internet-sidecar`. |
